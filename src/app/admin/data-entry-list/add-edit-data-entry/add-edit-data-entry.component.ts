...
@Component({
  selector: 'app-add-edit-data-entry',
  templateUrl: './add-edit-data-entry.component.html',
  styleUrls: ['./add-edit-data-entry.component.scss']
})
export class AddEditDataEntryComponent extends BaseService implements OnInit {
  form: FormGroup;
  Genders = Gender;
  countries: any[] = [];
  companies: any[] = [];
